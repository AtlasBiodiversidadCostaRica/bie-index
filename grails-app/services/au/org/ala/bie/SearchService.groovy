    ...
    def getTaxon(taxonLookup, List<Locale> locales){
        ...
        def model = [
                ...
                plicDescriptions: plicDescriptions.collect { plicDescription ->
                    ...
                    [
                            abstract: plicDescription.abstract,
                            annualCycleUnstructured: plicDescription.annualCycleUnstructured,
                            audiencesUnstructured: plicDescription.audiencesUnstructured,
                            behaviorUnstructured: plicDescription.behaviorUnstructured,
                            briefDescription: plicDescription.briefDescription,
                            detailUnstructured: plicDescription.detailUnstructured,
                            directThreatUnstructured: plicDescription.directThreatUnstructured,
                            dispersalMeans: plicDescription.dispersalMeans,
                            dispersalUnstructured: plicDescription.dispersalUnstructured,
                            distributionUnstructured: plicDescription.distributionUnstructured,
                            ecologicalSignificanceUnstructured: plicDescription.ecologicalSignificanceUnstructured,
                            endemicUnstructured: plicDescription.endemicUnstructured,
                            endTimeInterval: plicDescription.endTimeInterval,
                            environmentalEnvelopeUnstructured: plicDescription.environmentalEnvelopeUnstructured,
                            event: plicDescription.event,
                            feedingType: plicDescription.feedingType,
                            ...
                            impactMechanism: plicDescription.impactMechanism,
                            impactTarget: plicDescription.impactTarget,
                            interactionSpeciesType: plicDescription.interactionSpeciesType,
                            interactionUnstructured: plicDescription.interactionUnstructured,
                            invasivenessUnstructured: plicDescription.invasivenessUnstructured,
                            keys: plicDescription.keys,
                            language: plicDescription.language,
                            legislationUnstructured: plicDescription.legislationUnstructured,
                            lifeCycleUnstructured: plicDescription.lifeCycleUnstructured,
                            lifeFormUnstructured: plicDescription.lifeFormUnstructured,
                            managementAndConservationUnstructured: plicDescription.managementAndConservationUnstructured,
                            migratoryUnstructured: plicDescription.migratoryUnstructured,
                            molecularDataUnstructured: plicDescription.molecularDataUnstructured,
                            naturalHistoryUnstructured: plicDescription.naturalHistoryUnstructured,
                            ...
                            route: plicDescription.route,
                            startTimeInterval: plicDescription.startTimeInterval,
                            structureDispersed: plicDescription.structureDispersed,
                            synonymsUnstructured: plicDescription.synonymsUnstructured,
                            territoryUnstructured: plicDescription.territoryUnstructured,
                            threatStatusUnstructured: plicDescription.threatStatusUnstructured,
                            trophicStrategy: plicDescription.trophicStrategy,
                            trophicStrategyRemarks: plicDescription.trophicStrategyRemarks,
                            usesUnstructured: plicDescription.usesUnstructured,
                            vector: plicDescription.vector,
                            whatImpact: plicDescription.whatImpact                            
                    ]
                }                
