...
public enum CRBioTerm implements Term {
    ...
    /** NaturalHistory element (i.e. anytning related to LifeForm, LifeCycle, Reproduction, AnnualCycles,  Feeding,  Dispersal,  Behavior,  Interactions, MolecularData, MigratoryData,  EcologicalSignificance,  EnvironmentalEnvelope) as a text block. */
